...
namespace Xunit.Sdk
{
    ...
    {
        private static readonly ConcurrentDictionary<Type, string> TypeToTypeNameMap =
        ...
        public static Type GetType(string assemblyQualifiedTypeName)
        {
            ...
            if (firstOpenSquare > 0)
            {
                ...
                if (backtick > 0 && backtick < firstOpenSquare)
                {
                    ...
                    {
                        // Malformed, because we never closed what we opened
                        if (depth != 0)
                            return null;
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        /// </summary>
        /// <returns>Returns the type name as a string.</returns>
