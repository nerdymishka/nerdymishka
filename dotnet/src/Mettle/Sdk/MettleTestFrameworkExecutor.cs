...
namespace Mettle.Xunit.Sdk
{
    ...
    {
        private readonly Lazy<MettleTestFrameworkDiscoverer> discoverer;

        /// <summary>
        /// Initializes a new instance of the <see cref="MettleTestFrameworkExecutor"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the test assembly that contains the test.
        /// </summary>
        ...
        {
            if (value.Length > 3 && value.StartsWith(":F:", false, System.Globalization.CultureInfo.InvariantCulture))
            {
