...
namespace NerdyMishka.Security.Cryptography
{
    ...
    /// </summary>
    public class NerdyRfc2898DeriveBytes : DeriveBytes
    {
        ...
        public NerdyRfc2898DeriveBytes(byte[] password, byte[] salt, int iterations)
        ...
        public NerdyRfc2898DeriveBytes(byte[] password, byte[] salt, int iterations, HashAlgorithmName hashAlgorithm)
        {
            if (salt == null)
        ...
        public NerdyRfc2898DeriveBytes(string password, byte[] salt)
             : this(password, salt, 1000)
        {
        }

        public NerdyRfc2898DeriveBytes(string password, byte[] salt, int iterations)
            : this(password, salt, iterations, HashAlgorithmName.SHA1)
        {
        }
        ...
        public NerdyRfc2898DeriveBytes(string password, int saltSize)
            : this(password, saltSize, 1000)
        {
        }

        public NerdyRfc2898DeriveBytes(string password, int saltSize, int iterations)
...
#if NETSTANDARD2_0 || NET461 || NET451
        private byte[] Func()
        {
