...
namespace NerdyMishka.Security.Cryptography
{
    ...
    public class AesDeriveBytes : DeriveBytes
    {
        ...
        private void Func()
        {
            ...
            {
                transform.TransformBlock(this.block, 0, 16, this.block, 0);
                transform.TransformBlock(this.block, 16, 16, this.block, 16);
            }
        ...
        private void Initialize()
        {
            ...
            var l = Math.Min(password.Length, this.block.Length);
